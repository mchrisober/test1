...
public class AlarmReceiverWindingDown extends BroadcastReceiver {

    /* renamed from: a  reason: collision with root package name */
    public int f10178a = 99;
    ...
    public void onReceive(Context context, Intent intent) {
        if (q.k(context)) {
            ...
            if (Build.VERSION.SDK_INT < 26) {
                ...
                h.b bVar = new h.b();
                bVar.h(context.getString(R.string.reminder_wind_down_txt));
                dVar.s(bVar);
                ...
                dVar.p(1);
                dVar.i(activity);
                dVar.j(context.getString(R.string.reminder_wind_down_txt));
                Notification b2 = dVar.b();
                int i2 = 1 | b2.defaults;
                b2.defaults = i2;
                b2.defaults = i2 | 2;
                notificationManager.notify(this.f10178a, b2);
                return;
            }
            ...
            h.b bVar2 = new h.b();
            bVar2.h(context.getString(R.string.reminder_wind_down_txt));
            dVar2.s(bVar2);
            dVar2.e(true);
            dVar2.j(context.getString(R.string.reminder_wind_down_txt));
            dVar2.i(activity);
            notificationManager.notify(this.f10178a, dVar2.b());
        }
    }
}
