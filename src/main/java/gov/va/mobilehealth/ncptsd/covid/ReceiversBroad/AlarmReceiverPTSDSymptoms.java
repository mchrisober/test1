...
public class AlarmReceiverPTSDSymptoms extends BroadcastReceiver {

    /* renamed from: a  reason: collision with root package name */
    public int f10173a = 88;
    ...
    public void onReceive(Context context, Intent intent) {
        if (q.g(context)) {
            ...
            h.b bVar = new h.b();
            bVar.h(context.getString(R.string.due_assessment));
            dVar.s(bVar);
            dVar.e(true);
            dVar.j(context.getString(R.string.due_assessment));
            dVar.i(activity);
            ((NotificationManager) context.getSystemService("notification")).notify(this.f10173a, dVar.b());
        }
    }
}
