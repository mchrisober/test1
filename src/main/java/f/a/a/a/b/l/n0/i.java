...
/* compiled from: Frag_tool_RID_start_identify */
public class i extends b implements View.OnClickListener {
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("gov.va.mobilehealth.ACTION_DONE")) {
                i.this.c0.W(e.X1(i.this.j0, i.this.k0, i.this.l0, i.this.m0, i.this.n0), i.this.Q(R.string.rid_identify));
            }
        }
    }
    ...
    public static i c2(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        i iVar = new i();
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.h0 = (TextView) inflate.findViewById(R.id.rid_next_steps_txt_content_1);
        this.i0 = (TextView) inflate.findViewById(R.id.rid_next_steps_txt_content_2);
        if (this.l0 == null) {
        ...
        this.h0.setText(Html.fromHtml(Q(R.string.rid_identify_text_1)));
        this.i0.setText(Html.fromHtml(Q(R.string.rid_identify_text_2)));
        return inflate;
    }
