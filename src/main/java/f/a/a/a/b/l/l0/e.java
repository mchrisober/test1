...
/* compiled from: Frag_tool_findMeaning_intro */
public class e extends vainstrum.Components.b implements View.OnClickListener {
    ...
    class b implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i2) {
            dialogInterface.dismiss();
            new f.a.a.a.b.p.a(e.this.n(), e.this.v(), new i()).execute(new Void[0]);
        }
    }
    ...
    class c extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (e.this.m0 == -1) {
                ...
                e.this.c0.W(h.W1(e.this.j0, e.this.l0, e.this.m0, e.this.n0), e.this.Q(R.string.distress_meter));
            }
        }
    }
    ...
    public static e b2(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        e eVar = new e();
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.frag_tool_find_meaning_intro, viewGroup, false);
