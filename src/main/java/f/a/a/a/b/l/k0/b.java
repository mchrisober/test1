...
/* compiled from: Frag_tool_time_out_timer */
public class b extends vainstrum.Components.b {
    ...
    /* renamed from: f.a.a.a.b.l.k0.b$b  reason: collision with other inner class name */
    /* compiled from: Frag_tool_time_out_timer */
    class View$OnClickListenerC0204b implements View.OnClickListener {
        View$OnClickListenerC0204b() {
        }
    ...
    class d extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            b.this.q0 = false;
            b.this.c0.W(h.W1(b.this.h0, b.this.j0, b.this.k0, b.this.l0), b.this.Q(R.string.distress_meter));
        }
    }
    ...
    public class e extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            sb.append(b.this.Q(R.string.timer_ended));
            b.this.e0.setText("00:00");
            b.this.e0.setContentDescription(sb);
            b.this.m0 = null;
        }
        ...
        public void onTick(long j2) {
            ...
            String T = m.T(b.this.n(), b.this.n0);
            b.this.e0.setContentDescription(T);
            if (b.this.p0 && m.t0(b.this.n0)) {
                b.this.e0.announceForAccessibility(T);
            }
            b.this.e0.setText(sb2);
        }
    }

    public static b l2(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        b bVar = new b();
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.frag_tool_time_out_timer, (ViewGroup) null);
        this.d0 = (TextView) inflate.findViewById(R.id.time_out_txt_content);
        this.e0 = (TextView) inflate.findViewById(R.id.time_out_txt_countdown);
        this.f0 = (FABTracking) inflate.findViewById(R.id.time_out_btn_previous);
        this.g0 = (FABTracking) inflate.findViewById(R.id.time_out_btn_next);
        LinearLayout linearLayout = (LinearLayout) inflate.findViewById(R.id.time_out_layout_btns_refreshers);
        this.f0.setOnClickListener(new a());
        this.g0.setOnClickListener(new View$OnClickListenerC0204b());
        if (this.o0 == null) {
            o2();
        } else {
            m2(false);
