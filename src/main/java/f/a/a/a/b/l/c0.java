...
/* compiled from: Frag_tool_soothe_senses */
public class c0 extends b implements View.OnClickListener {
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            h W1 = h.W1(c0.this.l0, c0.this.n0, c0.this.o0, c0.this.p0);
            W1.V1(c0.this.R1());
            c0.this.c0.W(W1, c0.this.Q(R.string.distress_meter));
        }
    }
    ...
    public static c0 b2(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        c0 c0Var = new c0();
    ...
    public void c2(boolean z) {
        ...
        this.i0.setText(this.q0.getJSONObject(this.u0).getString("title"));
        this.j0.setText(this.q0.getJSONObject(this.u0).getString("content"));
        this.j0.announceForAccessibility(Q(R.string.content_changed) + "\n" + ((Object) this.i0.getText()) + ", " + ((Object) this.j0.getText()));
    }
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.frag_tool_soothe_senses, (ViewGroup) null);
        ...
        this.i0 = (TextView) inflate.findViewById(R.id.soothe_senses_txt_title);
        this.j0 = (TextView) inflate.findViewById(R.id.soothe_senses_txt_content);
        this.k0 = (AppCompatImageView) inflate.findViewById(R.id.soothe_senses_img);
        if (this.n0 == null) {
            this.h0.setVisibility(8);
        }
        this.k0.getLayoutParams().height = m.H(n1());
