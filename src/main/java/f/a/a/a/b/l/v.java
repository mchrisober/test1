...
/* compiled from: Frag_tool_help_falling_asleep */
public class v extends b implements View.OnClickListener {
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            h W1 = h.W1(v.this.k0, v.this.m0, v.this.n0, v.this.o0);
            W1.V1(v.this.R1());
            v.this.c0.W(W1, v.this.Q(R.string.distress_meter));
        }
    }
    ...
    public static v b2(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        v vVar = new v();
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.frag_tool_help_asleep, (ViewGroup) null);
        ...
        this.j0 = (TextView) inflate.findViewById(R.id.help_asleep_txt);
        ImageView imageView = (ImageView) inflate.findViewById(R.id.help_asleep_img);
        this.i0 = imageView;
        imageView.getLayoutParams().height = m.H(n());
        this.i0.setImageResource(R.drawable.t7);
        if (this.m0 == null) {
