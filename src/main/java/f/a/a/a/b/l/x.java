...
/* compiled from: Frag_tool_inspiring_quotes */
public class x extends b implements View.OnClickListener {
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            h W1 = h.W1(x.this.l0, x.this.n0, x.this.o0, x.this.p0);
            W1.V1(x.this.R1());
            x.this.c0.W(W1, x.this.Q(R.string.distress_meter));
        }
    }
    ...
    public static x b2(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        x xVar = new x();
    ...
    public void c2(boolean z) {
        ...
        this.j0.setText(this.q0.getJSONObject(this.u0).getString("attribution") + " ");
        this.k0.setText(this.q0.getJSONObject(this.u0).getString("quote"));
        this.k0.announceForAccessibility(Q(R.string.content_changed) + "\n" + this.q0.getJSONObject(this.u0).getString("quote") + ", " + this.q0.getJSONObject(this.u0).getString("attribution"));
    }
    ...
    public void onClick(View view) {
        if (view.getId() == this.f0.getId()) {
            ...
            textView.announceForAccessibility(((Object) this.k0.getText()) + " - " + this.j0.getText().toString());
        }
        if (view.getId() == this.g0.getId()) {
            c2(true);
            TextView textView2 = this.k0;
            textView2.announceForAccessibility(((Object) this.k0.getText()) + " - " + this.j0.getText().toString());
        }
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.frag_tool_inspiring_quotes, (ViewGroup) null);
        ...
        this.k0 = (TextView) inflate.findViewById(R.id.inspiring_quotes_txt_content);
        this.j0 = (TextView) inflate.findViewById(R.id.inspiring_quotes_txt_attribution);
        this.i0 = (ImageView) inflate.findViewById(R.id.inspiring_quotes_img);
        if (this.n0 == null) {
            this.h0.setVisibility(8);
        }
        this.i0.getLayoutParams().height = m.H(n());
        this.i0.setImageResource(R.drawable.t30);
