...
/* compiled from: Frag_tool_thoughts_shifting_start */
public class b extends vainstrum.Components.b implements View.OnClickListener {
    ...
    public static b W1(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        b bVar = new b();
    ...
    public void onClick(View view) {
        if (view.getId() == this.h0.getId()) {
            this.c0.W(a.l2(this.i0, this.j0, this.k0, this.l0, this.m0), Q(R.string.thought_shifting_timer));
        }
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.frag_tool_thought_shifting_start, (ViewGroup) null);
        ...
        this.g0 = (AppCompatImageView) inflate.findViewById(R.id.thought_shifting_img);
        if (this.k0 == null) {
