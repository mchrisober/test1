...
/* compiled from: Frag_tool_appreciations.kt */
public final class q extends vainstrum.Components.b implements View.OnClickListener {
    ...
    public ArrayList<f.a.a.a.b.d.a> l0;
    private HashMap m0;
    ...
    public static final class a {
        ...
        public final q a(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
            q qVar = new q();
            Bundle bundle = new Bundle();
            bundle.putSerializable(q.n0, b0Var);
            bundle.putSerializable(q.o0, b0Var2);
            bundle.putSerializable(q.p0, a0Var);
            bundle.putInt(q.q0, i2);
    ...
    public static final class b extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (this.f9604a.g0 == -1) {
                Act_manage act_manage = this.f9604a.c0;
                f.c(act_manage);
                act_manage.finish();
                return;
            }
            h W1 = h.W1(this.f9604a.h2(), this.f9604a.g2(), this.f9604a.g0, this.f9604a.h0);
            f.d(W1, "frag");
            W1.V1(this.f9604a.R1());
            Act_manage act_manage2 = this.f9604a.c0;
            f.c(act_manage2);
            act_manage2.W(W1, this.f9604a.Q(R.string.distress_meter));
        }
    }
    ...
    static final class c implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            this.f9605b.F1(new Intent(this.f9605b.p1(), Act_new_appreciation.class));
        }
    }
    ...
    public void N0(View view, Bundle bundle) {
        ...
        ((ImageView) X1(i2)).setImageResource(R.drawable.img_appreciations);
        ...
        try {
            g0.k(n(), D(), (LinearLayout) X1(o.rewarding_good_behavior_layout_container), j.N(n(), g.L), R.dimen.txt_normal, R.dimen.padding_large, 17170444, false);
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        ...
        fABTracking.setContentDescription(Q(R.string.add_appreciation));
        if (this.f0 == null) {
    ...
    public final void i2() {
        ...
        ArrayList<f.a.a.a.b.d.a> J = new y(p1).J();
        this.l0 = J;
        if (J == null) {
            f.p("appreciations");
            throw null;
            ...
            ArrayList<f.a.a.a.b.d.a> arrayList = this.l0;
            if (arrayList != null) {
                v vVar = new v(n1, arrayList);
    ...
    public void o0(Bundle bundle) {
        ...
        if (o1.containsKey(str)) {
            this.d0 = (b0) o1().getSerializable(str);
        }
        if (o1().containsKey(str)) {
            this.e0 = (b0) o1().getSerializable(str);
        }
        Bundle o12 = o1();
        String str2 = p0;
