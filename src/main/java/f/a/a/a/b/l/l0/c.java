...
/* compiled from: Frag_tool_familyAudio_intro_continue */
public class c extends vainstrum.Components.b implements View.OnClickListener {
    ...
    class b implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i2) {
            dialogInterface.dismiss();
            new f.a.a.a.b.p.a(c.this.n(), c.this.v(), new i()).execute(new Void[0]);
        }
    }

    /* renamed from: f.a.a.a.b.l.l0.c$c  reason: collision with other inner class name */
    /* compiled from: Frag_tool_familyAudio_intro_continue */
    class C0207c extends BroadcastReceiver {
        C0207c() {
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (c.this.m0 == -1) {
                ...
                c.this.c0.W(h.W1(c.this.j0, c.this.l0, c.this.m0, c.this.n0), c.this.Q(R.string.distress_meter));
            }
        }
    }
    ...
    public static c b2(b0 b0Var, b0 b0Var2, a0 a0Var, int i2, String str) {
        c cVar = new c();
    ...
    public View s0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.frag_tool_family_audio_intro_continue, viewGroup, false);
        ...
        this.e0 = (AppCompatButton) inflate.findViewById(R.id.bottom_tool_btn_continue);
