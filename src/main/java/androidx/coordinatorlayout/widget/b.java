...
public class b {
    ...
    private static final ThreadLocal<Matrix> f1016a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f1017b = new ThreadLocal<>();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f1016a;
        ...
        ThreadLocal<RectF> threadLocal2 = f1017b;
