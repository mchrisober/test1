...
public class g implements b.h.f.a.a {
    ...
    private ArrayList<i> f356f;

    /* renamed from: g  reason: collision with root package name */
    private ArrayList<i> f357g;

    /* renamed from: h  reason: collision with root package name */
    private boolean f358h;

    /* renamed from: i  reason: collision with root package name */
    private ArrayList<i> f359i;

    /* renamed from: j  reason: collision with root package name */
    private ArrayList<i> f360j;
    ...
    private void N(int i2, boolean z2) {
        if (i2 >= 0 && i2 < this.f356f.size()) {
            this.f356f.remove(i2);
            if (z2) {
                K(true);
            }
        }
    ...
    private void b0(boolean z2) {
        boolean z3 = true;
        if (!z2 || this.f352b.getConfiguration().keyboard == 1 || !v.e(ViewConfiguration.get(this.f351a), this.f351a)) {
            z3 = false;
        }
        this.f354d = z3;
    }
    ...
    public MenuItem a(int i2, int i3, int i4, CharSequence charSequence) {
        ...
        ArrayList<i> arrayList = this.f356f;
    ...
    public boolean hasVisibleItems() {
        ...
        int size = size();
        for (int i2 = 0; i2 < size; i2++) {
            if (this.f356f.get(i2).isVisible()) {
                return true;
            }
        }
        return false;
    ...
    public int m(int i2, int i3) {
        ...
        while (i3 < size) {
            if (this.f356f.get(i3).getGroupId() == i2) {
                return i3;
            }
            i3++;
        }
    ...
    public int o(int i2) {
        int size = size();
        for (int i3 = 0; i3 < size; i3++) {
            if (this.f356f.get(i3).getItemId() == i2) {
                return i3;
            }
        }
        return -1;
    ...
    public i p(int i2, KeyEvent keyEvent) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if ((c2 == cArr[0] && (metaState & 2) == 0) || ((c2 == cArr[2] && (metaState & 2) != 0) || (G && c2 == '\b' && i2 == 67))) {
                return iVar;
            }
        }
        return null;
    ...
    public void removeGroup(int i2) {
        int l2 = l(i2);
        if (l2 >= 0) {
            int size = this.f356f.size() - l2;
            int i3 = 0;
            while (true) {
                int i4 = i3 + 1;
                if (i3 >= size || this.f356f.get(l2).getGroupId() != i2) {
                    K(true);
                } else {
                    N(l2, false);
                    i3 = i4;
    ...
    public MenuItem add(int i2) {
        return a(0, 0, 0, this.f352b.getString(i2));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i2) {
        return addSubMenu(0, 0, 0, this.f352b.getString(i2));
    }
    ...
    public SubMenu addSubMenu(int i2, int i3, int i4, CharSequence charSequence) {
        ...
        r rVar = new r(this.f351a, this, iVar);
        iVar.x(rVar);
        return rVar;
    }
    ...
    public MenuItem add(int i2, int i3, int i4, int i5) {
        return a(i2, i3, i4, this.f352b.getString(i5));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i2, int i3, int i4, int i5) {
        return addSubMenu(i2, i3, i4, this.f352b.getString(i5));
    }
}
