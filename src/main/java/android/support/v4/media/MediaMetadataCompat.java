...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final b.e.a<String, Integer> f43d;
    ...
    MediaMetadataCompat(Parcel parcel) {
        this.f44b = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
