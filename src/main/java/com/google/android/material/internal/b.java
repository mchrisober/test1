...
public class b {
    ...
    private static final ThreadLocal<Matrix> f7828a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f7829b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f7828a;
        ...
        ThreadLocal<RectF> threadLocal2 = f7829b;
