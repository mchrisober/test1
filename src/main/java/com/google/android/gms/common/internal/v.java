...
public final class v {
    ...
    private static final g<String, String> f7414a = new g<>();
    @GuardedBy("sCache")

    /* renamed from: b  reason: collision with root package name */
    private static Locale f7415b;
    ...
    private static String c(Context context, String str) {
        g<String, String> gVar = f7414a;
        synchronized (gVar) {
            Locale c2 = c.a(context.getResources().getConfiguration()).c(0);
            if (!c2.equals(f7415b)) {
                gVar.clear();
                f7415b = c2;
            }
    ...
    private static String e(Context context) {
        ...
        try {
            return com.google.android.gms.common.l.b.a(context).b(packageName).toString();
    ...
    public static String f(Context context, int i2) {
        String str;
        if (i2 == 6) {
            str = c(context, "common_google_play_services_resolution_required_title");
        } else {
            str = b(context, i2);
        }
    ...
    public static String g(Context context, int i2) {
        ...
        } else if (com.google.android.gms.common.util.f.e(context)) {
