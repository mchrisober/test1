...
public class HorizontalBarHighlighter extends BarHighlighter {
    ...
    /* access modifiers changed from: protected */
    @Override // com.github.mikephil.charting.highlight.ChartHighlighter, com.github.mikephil.charting.highlight.BarHighlighter
    public float getDistance(float f2, float f3, float f4, float f5) {
        return Math.abs(f3 - f5);
    }

    @Override // com.github.mikephil.charting.highlight.ChartHighlighter, com.github.mikephil.charting.highlight.IHighlighter, com.github.mikephil.charting.highlight.BarHighlighter
